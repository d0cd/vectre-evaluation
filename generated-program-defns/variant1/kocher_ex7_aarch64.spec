...
ENTRY_4194304:
    ...
    0x400008: add__r__r__n x8, x8, 0x88bv64;
...
ENTRY_4194392:
    0x400058: ldr__r__t_2_r_n_post x8, (sp, 8);
    0x40005c: adrp__r__n x9, 0x500000bv64;
    0x400060: add__r__r__n x9, x9, 0x18bv64;
    0x400064: ldr__r__t_1_r_post x9, (x9);
    0x400068: cmp__r__r x8, x9;
    0x40006c: b_hs__n 0x400080bv64;
ENTRY_4194336:
    0x400020: ldr__r__t_2_r_n_post x8, (sp, 8);
    0x400024: adrp__r__n x9, 0x500000bv64;
    ...
    0x400038: adrp__r__n x8, 0x500000bv64;
    0x40003c: add__r__r__n x8, x8, 8;
    0x400040: ldrb__r__t_2_r_r_sxtw_post w10, (x8, w10);
    0x400044: adrp__r__n x8, 0x500000bv64;
    0x400048: add__r__r__n x8, x8, 0x10bv64;
    ...
    0x40006c: b_hs__n 0x400080bv64;
ENTRY_4194432:
    0x400080: add__r__r__n sp, sp, 0x10bv64;
    0x400084: ret;
ENTRY_4194416:
    0x400070: ldr__r__t_2_r_n_post x8, (sp, 8);
    0x400074: adrp__r__n x9, 0x400000bv64;
    0x400078: add__r__r__n x9, x9, 0x88bv64;
    0x40007c: str__r__t_1_r_post x8, (x9);
    0x400080: add__r__r__n sp, sp, 0x10bv64;
    0x400084: ret;
}
