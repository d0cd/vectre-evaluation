...
ENTRY_4194304:
    ...
    0x400012: movzx__r__p_byte eax, rcx + 0x500000bv64;
    0x40001a: movzx__r__p_byte edx, 0x500008bv64;
    0x400022: and__r__r edx, eax;
    0x400024: mov__p_byte__r 0x500008bv64, dl;
    0x40002b: pop__r rbp;
    0x40002c: ret;
ENTRY_4194352:
    ...
    0x400040: cmp__r__p_qword rax, 0x500010bv64;
    0x400048: jae__w 0x400061bv64;
ENTRY_4194382:
    0x40004e: mov__r__p_qword rax, rbp - 8;
    0x400052: movzx__r__p_byte edi, rax + 0x500018bv64;
    0x40005a: mov__r__w al, 0;
    0x40005c: call__w 0x500020bv64;
ENTRY_4194401:
