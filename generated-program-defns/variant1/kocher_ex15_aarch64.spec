...
ENTRY_4194340:
    ...
    0x400048bv64: ldrb__r__t_2_r_r_sxtw_post w10, (x8, w10);
    0x40004cbv64: adrp__r__n x8, 0x500000bv64;
    0x400050bv64: add__r__r__n x8, x8, 0x18bv64;
    0x400054bv64: ldrb__r__t_1_r_post w11, (x8);
    0x400058bv64: and__r__r__r w10, w11, w10;
    0x40005cbv64: strb__r__t_1_r_post w10, (x8);
    0x400060bv64: add__r__r__n sp, sp, 0x10bv64;
    0x400064bv64: ret;
}
