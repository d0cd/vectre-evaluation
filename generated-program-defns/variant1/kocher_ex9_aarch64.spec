...
ENTRY_4194304:
    ...
    0x400004: str__r64__t_2_r_n gpr_0, (sp, 8);
    0x400008: str__r64__t_1_r gpr_1, (sp);
    0x40000c: ldr__r64__t_1_r gpr_8, (sp);
    0x400010: ldr__r32__t_1_r gpr_9, (x8);
    0x400014: cbz__r32__n gpr_9, 0x400050bv64;
ENTRY_4194384:
    0x400050: add__r64__r64__n sp, sp, 0x10bv64;
    0x400054: ret;
ENTRY_4194328:
    0x400018: ldr__r64__t_2_r_n gpr_8, (sp, 8);
    0x40001c: adrp__r64__n gpr_9, 0x500000bv64;
    0x400020: add__r64__r64__n gpr_9, gpr_9, 0;
    0x400024: ldrb__r32__t_2_r_r gpr_10, (x9, x8);
