...
ENTRY_4194334:
    ...
    0x400030: jne__w 0x40004f;
ENTRY_4194388:
    0x400054: pop__r rbp;
    0x400055: ret;
ENTRY_4194358:
    0x400036: movzx__r__p_byte eax, 0x500010;
    0x40003e: movzx__r__p_byte ecx, 0x500018;
    0x400046: and__r__r ecx, eax;
    0x400048: mov__p_byte__r 0x500018, cl;
    0x40004f: jmp__w 0x400054;
ENTRY_4194383:
    0x40004f: jmp__w 0x400054;
}
