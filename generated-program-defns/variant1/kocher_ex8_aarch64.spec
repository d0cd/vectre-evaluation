...
ENTRY_4194352:
    ...
    0x400034: str__r__t_1_r_post x8, (sp);
    0x400038: ldr__r__t_1_r_post x8, (sp);
    0x40003c: adrp__r__n x9, 0x500000bv64;
    0x400040: add__r__r__n x9, x9, 8;
    0x400044: ldrb__r__t_2_r_r_post w10, (x9, x8);
    0x400048: movz__r__n w11, 0x200bv64;
    0x40004c: mul__r__r__r w10, w10, w11;
    0x400050: adrp__r__n x8, 0x500000bv64;
    0x400054: add__r__r__n x8, x8, 0x10bv64;
    0x400058: ldrb__r__t_2_r_r_sxtw_post w10, (x8, w10);
    0x40005c: adrp__r__n x8, 0x500000bv64;
    0x400060: add__r__r__n x8, x8, 0x18bv64;
    0x400064: ldrb__r__t_1_r_post w11, (x8);
    0x400068: and__r__r__r w10, w11, w10;
    0x40006c: strb__r__t_1_r_post w10, (x8);
    0x400070: add__r__r__n sp, sp, 0x10bv64;
    0x400074: ret;
ENTRY_4194336:
