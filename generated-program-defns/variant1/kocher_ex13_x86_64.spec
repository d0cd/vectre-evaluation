...
ENTRY_4194304:
    ...
    0x400010: call__w 0x500000;
ENTRY_5242880:

ENTRY_4194325:
    0x400015: cmp__r__w eax, 0;
    0x400018: je__w 0x400049;
ENTRY_4194377:
    0x400049: add__r__w rsp, 0x10;
    0x40004d: pop__r rbp;
    0x40004e: ret;
ENTRY_4194334:
    ...
    0x400030: movzx__r__p_byte ecx, rax + 0x500010;
    0x400038: movzx__r__p_byte edx, 0x500018;
    0x400040: and__r__r edx, ecx;
    0x400042: mov__p_byte__r 0x500018, dl;
    0x400049: add__r__w rsp, 0x10;
    0x40004d: pop__r rbp;
    0x40004e: ret;
}
