prog _generated-binaries_variant1_kocher_ex1_mips64_unknown_linux_elf {
ENTRY_4194304:
    ...
    4194352:	sd	$at, ($fp);
    4194356:	beqz	$a1, 0x400080;
    4194360:	nop;
ENTRY_4194456:
    4194456:	daddiu	$sp, $sp, -0x10;
    4194460c:	sd	$ra, 8($sp);
    4194464a0:	sd	$fp, ($sp);
    4194468a4:	move	$fp, $sp;
    4194472a8:	move	$sp, $fp;
    4194476ac:	ld	$fp, ($sp);
    4194480b0:	ld	$ra, 8($sp);
    4194484b4:	daddiu	$sp, $sp, 0x10;
    4194488b8:	jr	$ra;
    4194492bc:	nop;
ENTRY_4194432:
    4194432:	move	$sp, $fp;
