...
ENTRY_4194304:
    ...
    0x400014: str__r64__t_2_r_n gpr_0, (sp, 8);
    0x400018: ldr__r64__t_2_r_n gpr_9, (sp, 8);
    0x40001c: ldr__r64__t_1_r gpr_8, (x8);
    0x400020: cmp__r64__r64 gpr_9, gpr_8;
    0x400024: b_hs__n 0x400074bv64;
ENTRY_4194420:
    0x400074: ldp__r64__r64__t_2_r_n gpr_29, gpr_30, (sp, 0x10bv64);
...
ENTRY_4194344:
    ...
    0x400064: str__r64__t_1_r gpr_8, (sp);
    0x400068: bl__n 0x500020bv64;

ENTRY_4194412:
    0x40006c: ldr__r64__t_1_r gpr_8, (sp);
    0x400070: strb__r32__t_1_r gpr_0, (x8);
    0x400074: ldp__r64__r64__t_2_r_n gpr_29, gpr_30, (sp, 0x10bv64);
    0x400078: add__r64__r64__n sp, sp, 0x20bv64;
    0x40007c: ret;
}
