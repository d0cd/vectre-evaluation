...
ENTRY_4194304:
    ...
    0x40000c: cmp__r__p_qword rax, 0x400068;
    0x400014: jne__w 0x400045;
ENTRY_4194330:
    0x40001a: mov__r__p_qword rax, rbp - 8;
    0x40001e: movzx__r__p_byte ecx, rax + 0x500000;
    0x400026: shl__r__w ecx, 9;
    0x400029: movsxd__r__r rax, ecx;
    0x40002c: movzx__r__p_byte ecx, rax + 0x500008;
    0x400034: movzx__r__p_byte edx, 0x500010;
    0x40003c: and__r__r edx, ecx;
    0x40003e: mov__p_byte__r 0x500010, dl;
    0x400045: mov__r__p_qword rax, rbp - 8;
    0x400049: cmp__r__p_qword rax, 0x500018;
    0x400051: jae__w 0x400063;
ENTRY_4194373:
    0x400045: mov__r__p_qword rax, rbp - 8;
    0x400049: cmp__r__p_qword rax, 0x500018;
    0x400051: jae__w 0x400063;
ENTRY_4194391:
    ...
    0x40005b: mov__p_qword__r 0x400068, rax;
    0x400063: pop__r rbp;
    0x400064: ret;
ENTRY_4194403:
    0x400063: pop__r rbp;
